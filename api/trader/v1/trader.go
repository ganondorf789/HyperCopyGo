...
// 已完成交易列表
type TraderCompletedTradesListReq struct {
	g.Meta    `path:"/trader/completed-trades" tags:"Trader" method:"get" summary:"已完成交易列表" login_required:"true"`
...
type TraderCompletedTradesListRes struct {
	g.Meta `mime:"application/json"`
