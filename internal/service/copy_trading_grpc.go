...
type ICopyTradingGrpc interface {
	...
	SendCopyTradingNotification(ctx context.Context, appId, appSecret string, in *v1.SendCopyTradingNotificationReq) (int64, error)
	UpdateCopyTradingStatus(ctx context.Context, appId, appSecret string, in *v1.UpdateCopyTradingStatusReq) error
}
